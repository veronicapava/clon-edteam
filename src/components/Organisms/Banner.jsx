          ...
          home ?
            <div className="ed-grid m-grid-2">
              <div className="main-banner__data">
                ...
                <p>{subtitle}</p>
                <Link to="/cursos" className="button first-color">Ver Cursos</Link>
              </div>
              <div className="img-container s-ratio-16-9">
                <img src={poster} alt="Programador" />
              </div>
            </div>
            :
            courseBanner ?
              <div className="ed-grid m-grid-3">
                <div className="main-banner__data m-cols-2">
                  ...
                  {
                    especialidad &&
                    <p>Este curso pertenece a la especialidad <Link to="/especialidades">{especialidad}</Link></p>
                  }
                </div>
