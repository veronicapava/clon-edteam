...
import { GET_ALL_COURSES, GET_ALL_POSTS, GET_ALL_SPECIALITIES, GET_ALL_TEACHERS, GET_COURSE, GET_POST, GET_SPECIALITY, GET_FRAGMENT } from "./actions";
...
export const getSpecility = id => dispatch => {
